...
from .views import SubmitSignatureFileView, ReviewerReviewRecordsView, ReviewRecordUpdateView, CancelPendingReviewRecordView
...
urlpatterns = [
    ...
    path('cancel-pdf-review/', CancelPendingReviewRecordView.as_view(), name='cancel-pdf-review'),
